...
import { flyToPrague, flyToAustin } from './camera.js';
...
import cdTransitLayer from './data/cdTransit.js';
import { initPragueMobileGuide } from './ui/pragueMobileGuide.js';
import { initCdTrainInspector } from './ui/cdTrainInspector.js';
...
async function init() {
  ...
  try {
    ...
    // If no share link state, do default fly-to Prague
    if (!styleManager.hasShareState) {
      loaderStatus.textContent = 'Flying to Prague, Czech Republic...';
      flyToPrague(viewer);
    } else {
    ...
    dataManager.register(cdTransitLayer);
    ...
    // Initialize České dráhy train inspector
    initCdTrainInspector(viewer);
